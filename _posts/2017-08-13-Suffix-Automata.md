...
Προκύπτει ότι σε ένα Suffix Automaton **όλα τα αλφαριθμητικά μιας ισοδύναμης κλάσης αντιστοιχούν στην ίδια κατάσταση**. Με άλλα λόγια, ο αριθμός των καταστάσεων σε ένα Suffix Automaton ισούται με τον αριθμό των ισοδύναμων κλάσεων συν ένα (από την αρχική κατάσταση). **Αποδεικνύεται όμως ότι στην χειρότερη περίπτωση θα υπάρχουν το πολύ $$2*len(S)$$ διαφορετικές καταστάσεις!!!** Αυτή την πρόταση θα την θεωρήσουμε δεδομένη. Ακολουθούν κάποιες απλές αλλά χρήσιμες προτάσεις σχετικά με τα σύνολα $$endpos$$.
