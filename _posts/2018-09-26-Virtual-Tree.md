...
**Απόδειξη:** Από την Brute Force κατασκευή φαίνεται ότι κάθε ένας από τους $$L$$ κόμβους κλειδιά προσθέτει **το πολύ έναν** επιπλέον κόμβο στο Virtual Tree. Τελικα δηλαδή, το Virtual Tree έχει $$O(L)$$ κόμβους συνολικά.
